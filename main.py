...
from view import inserir_categoria, ver_categoria, porcentagem_valor, inserir_receita, inserir_gastos, bar_valores, tabela, deletar_gastos, deletar_receitas, pie_valores
...
frameCima = Frame(width=1043, height=50, bg=co1, relief="flat")
frameCima.grid(row=0, column=0)

frameMeio = Frame(width=1043, height=361, bg=co1, pady=20, relief="raised")
frameMeio.grid(row=1, column=0,pady=1, padx=0, sticky=NSEW)

frameBaixo = Frame(width=1043, height=300, bg=co1, relief="flat")
frameBaixo.grid(row=2, column=0,pady=0, padx=10, sticky=NSEW)

frame_gra_pie = Frame(frameMeio, width=580, height=250, bg=co2)
frame_gra_pie.place(x=415, y=5)

# Trabalhando no Logo de Cima
...
app_logo = Label(frameCima, image=app_img, text="Controle Financeiro Para Motoristas de Aplicativo", width=900, compound=LEFT, padx=5, relief=RAISED, anchor=NW, font=('Verdana 20 bold'), bg=co1, fg=co4, )
...
def inserir_receitas_b():
    ...
    # Chamando a função de inserir receitas presentes na view

    inserir_receita(lista_inserir)

    messagebox.showinfo('Sucesso', 'Os dados foram inseridos com sucesso')

    e_ca_receitas.delete(0,'end')
    e_valor_receitas.delete(0,'end')

    #Atualizando dados da Receitas
    mostrar_renda()
    porcentagem()
    grafico_bar()
    resumo()
...
def inserir_despesas_b():
    ...
    # Chamando a função de inserir Despesas presentes na view

    inserir_gastos(lista_inserir)

    messagebox.showinfo('Sucesso', 'Os dados foram inseridos com sucesso')

    combo_categoria_despesas.delete(o,'end')
    e_ca_despesas.delete(0,'end')
    e_valor_despesas.delete(0,'end')

    #Atualizando dados da Despesas
    mostrar_renda()
    porcentagem()
    grafico_bar()
    resumo()
...
def resumo():
    ...
    l_sumario = Label(frameMeio, text="Total Saldo Mensal     ".upper(), height=1, anchor=NW, font=('Verdana 12'), bg=co1, fg='#83a9e6')
...
# Configurações para  Inserir Despesas
...
# Despesas
l_ca_despesas = Label(frame_operacoes, text='Data', height=1, anchor=NW, font=('Ivy 10'), bg=co1, fg=co4)
l_ca_despesas.place(x=10, y=70)
e_ca_despesas = DateEntry(frame_operacoes, width=12, background='darkblue', foreground='white', borderwhith=2, year=2024)
e_ca_despesas.place(x=110,y=71)
...
# Acessando Botão Deletar

l_excluir = Label(frame_operacoes, text='Deletar ação', height=1, anchor=NW, font=('Ivy 10 bold'), bg=co1, fg=co4)
...
# Configurações para Inserir Receitas

l_info = Label(frame_configuracao, text='Insira Novos Ganhos', height=1, anchor=NW, font=('Verdana 10 bold'), bg=co1, fg=co4)
l_info.place(x=10, y=10)

# Receitas
l_ca_receitas = Label(frame_configuracao, text='Data', height=1, anchor=NW, font=('Ivy 10'), bg=co1, fg=co4)
l_ca_receitas.place(x=10, y=40)
e_ca_receitas = DateEntry(frame_configuracao, width=12, background='darkblue', foreground='white', borderwhith=2, year=2024)
e_ca_receitas.place(x=110,y=41)
...
# Acessando Botão Inserir receitas

img_add_receitas = Image.open('add.png')
img_add_receitas = img_add_receitas.resize((17,17))
img_add_receitas = ImageTk.PhotoImage(img_add_receitas)

botao_inserir_receitas = Button(frame_configuracao, command=inserir_receitas_b, image=img_add_despesas, text="Adicionar".upper(), width=80, compound=LEFT, anchor=NW, font=('Ivy 7 bold'), bg=co1, fg=co0, overrelief=RIDGE)
...
botao_inserir_categoria = Button(frame_configuracao, image=img_add_categoria, command=inserir_categoria_b, text="Adicionar".upper(), width=80, compound=LEFT, anchor=NW, font=('Ivy 7 bold'), bg=co1, fg=co0, overrelief=RIDGE)
